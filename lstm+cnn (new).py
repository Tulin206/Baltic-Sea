...
width = X_train.shape[3]       # 111
height = X_train.shape[4]      # 251
...
temperature_output = Dense(width * height, activation='linear')(lstm_layer)
print("Shape of dense layers for temperature:", temperature_output.shape)
temperature_output = Reshape((1, width, height), name='temperature_output')(temperature_output)  # 1 channel for temperature
...
salinity_output = Dense(width * height, activation='linear')(lstm_layer)
print("Shape of dense layers for salinity:", salinity_output.shape)
salinity_output = Reshape((1, width, height), name='salinity_output')(salinity_output)  # 1 channel for salinity
...
print("Shape of X_train before training:", X_train.shape)
